...
timelog:
  ...
  - activity: 
      ...
      duration: PT2H
  - activity: 
      description: fixing yaml errors, Methods transcription & cross check
      who: ashbonner310 
      start: 2026-09-23 T1800
      duration: PT1H
  - activity: 
      description: Methods citations
      who: ashbonner310 
      start: 2026-09-23 T2030
      duration: PT1H
---
...
methods.file <- "Kemp2003_Methods_AB.md"
...
- [Kemp2003_Methods.md](Kemp2003_Methods_AB.md)
...
+ Lead
  ...
  - [X] Update the author section of the yml to reflect who is working on the rescue
...
# You will want to repeat the line below to cross check each csv and md file in the
#... data rescue. Having no lines flagged by this command will ensure that each character matches exactly.
diff --strip-trailing-cr --suppress-common-lines -y temp/Kemp2003_Methods_CS.md Kemp2003_Methods_AB.md
```
